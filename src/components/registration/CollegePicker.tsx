      ...
      <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0" align="start">
        ...
        <div className="max-h-48 overflow-y-auto p-1">
          ...
          {filtered.map((c) => (
            <button
              ...
              className={cn(
                "w-full flex items-center gap-2 rounded-md px-2 py-1.5 text-sm text-left transition-colors hover:bg-accent hover:text-accent-foreground",
                value === c.name && "bg-accent/50"
              )}
            >
              <Check
                className={cn(
        ...
        <div className="border-t border-border p-1">
          <button
            ...
            className="w-full flex items-center gap-2 rounded-md px-2 py-1.5 text-sm text-primary hover:bg-accent transition-colors"
          >
