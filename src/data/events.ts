...
export const fallbackEvents: EventData[] = [
  {
    id: "fallback-hack-momentum", emoji: "⚡", name: "Hack Momentum",
  ...
  },
  {
    ...
    description: "A mega quiz to test your tech knowledge", category: "technical",
  ...
  {
    id: "fallback-poster-presentation", emoji: "📊", name: "Poster Presentation",
    description: "Present your ideas visually on a poster", category: "technical",
    teamSize: "1-2 members", team_size_min: 1, team_size_max: 2,
    detailedDescription: "Pixel Perfect challenges you to present complex technical ideas through visually compelling posters.",
    date: null, time: null, venue: null, prize_pool: null, rules: null, rulebookUrl: null,
  },
  {
    id: "fallback-pitch-perfect", emoji: "🎯", name: "Pitch Perfect",
    description: "Pitch your startup idea to a panel of judges", category: "technical",
    teamSize: "1-2 members", team_size_min: 1, team_size_max: 2,
  ...
  },
  {
    ...
    teamSize: "Solo", team_size_min: 1, team_size_max: 1,
  ...
  },
  {
    ...
    description: "Bust the myths with facts and logic", category: "technical",
    teamSize: "Solo", team_size_min: 1, team_size_max: 1,
  ...
  {
    id: "fallback-battle-ground", emoji: "🔥", name: "Battle Ground – Free Fire",
    description: "Free Fire tournament – last team standing wins!", category: "gaming",
  ...
  },
  {
    ...
    teamSize: "6-12 members", team_size_min: 6, team_size_max: 12,
  ...
  },
  {
    ...
    teamSize: "5-10 members", team_size_min: 5, team_size_max: 10,
