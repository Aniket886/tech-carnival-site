...
function buildHtml(payload: EmailPayload): string {
  ...
  const header = `
    <div style="position: relative; background: #0a0e1a; padding: 48px 24px 40px; text-align: center; overflow: hidden;">
      ...
      <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: radial-gradient(1px 1px at 10% 15%, rgba(255,255,255,0.5) 1px, transparent 0), radial-gradient(1px 1px at 25% 65%, rgba(255,255,255,0.3) 1px, transparent 0), radial-gradient(1.5px 1.5px at 45% 10%, rgba(56,189,248,0.6) 1px, transparent 0), radial-gradient(1px 1px at 60% 80%, rgba(255,255,255,0.4) 1px, transparent 0), radial-gradient(1px 1px at 75% 35%, rgba(168,85,247,0.5) 1px, transparent 0), radial-gradient(1.5px 1.5px at 85% 70%, rgba(255,255,255,0.35) 1px, transparent 0), radial-gradient(1px 1px at 15% 85%, rgba(56,189,248,0.4) 1px, transparent 0), radial-gradient(1px 1px at 35% 45%, rgba(255,255,255,0.25) 1px, transparent 0), radial-gradient(1.5px 1.5px at 55% 55%, rgba(168,85,247,0.4) 1px, transparent 0), radial-gradient(1px 1px at 90% 20%, rgba(255,255,255,0.45) 1px, transparent 0), radial-gradient(1px 1px at 5% 50%, rgba(255,255,255,0.3) 1px, transparent 0), radial-gradient(1px 1px at 70% 5%, rgba(56,189,248,0.35) 1px, transparent 0), radial-gradient(1.5px 1.5px at 50% 90%, rgba(255,255,255,0.4) 1px, transparent 0), radial-gradient(1px 1px at 20% 30%, rgba(168,85,247,0.3) 1px, transparent 0), radial-gradient(1px 1px at 95% 55%, rgba(255,255,255,0.35) 1px, transparent 0);"></div>
